...
class Test(Topo) :
    def build(self) :
        ...
        self.add_link_by_name('A', 'B', True, cost=1)
        self.add_link_by_name('B', 'C', True, cost=1)

        self.add_link_by_name('A', 'D', True, cost=2)
        self.add_link_by_name('D', 'C', True, cost=2)

        self.add_link_by_name('A', 'E', True, cost=4)
        self.add_link_by_name('E', 'C', True, cost=4)


        self.add_link_by_name('Dst', 'C', True, cost=100)
        self.add_link_by_name('Ctrl', 'A', True, cost=100)
