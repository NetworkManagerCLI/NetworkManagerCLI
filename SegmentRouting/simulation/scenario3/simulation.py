...
if __name__ == '__main__':
    ...
    prompt.do_halt_auto_schedule('stop checking')
    prompt.do_show_requirements('display')
    LOG.info('bw up requirement from A to B should be running')

    prompt.do_next_timestamp('12:00 BW idle')
    time.sleep(15)
    ...
    prompt.do_halt_auto_schedule('stop checking')
    prompt.do_show_requirements('display')
    LOG.info('BW requirement from A to B should not be removed')
